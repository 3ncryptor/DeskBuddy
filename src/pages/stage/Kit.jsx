      ...
      <div className="stage-container">
          ...
          <div className="header-content">
            <div className="header-left">
              ...
              <div className="page-info">
                <h1 className="page-title">Orientation Kit</h1>
                <p className="page-description">
                  Distribute orientation materials and manage kit distribution
                </p>
              </div>
            </div>
        ...
        <main className="stage-main">
          <div className="stage-cards">
            <div className="stage-card primary" onClick={() => navigate("/kit/scan")}>
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Scan student QR codes to distribute orientation kits
                </p>
              </div>
            ...
            <div className="stage-card secondary">
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Access kit distribution records and history
                </p>
