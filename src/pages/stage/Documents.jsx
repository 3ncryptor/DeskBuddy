      ...
      <div className="stage-container">
            ...
            <div className="header-left">
              ...
              <div className="page-info">
                ...
                <p className="page-description">
                  Review and validate student documents and certificates
                </p>
              </div>
            </div>
        ...
        <main className="stage-main">
          <div className="stage-cards">
            <div className="stage-card primary" onClick={() => navigate("/documents/scan")}>
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Scan student QR codes to verify documents
                </p>
              </div>
            ...
            <div className="stage-card secondary">
              ...
              <div className="card-content">
                ...
                <p className="card-description">
                  Access document verification records
                </p>
